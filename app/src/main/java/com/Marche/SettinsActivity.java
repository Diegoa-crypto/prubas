...
public class SettinsActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        storageProfilePrictureRef = FirebaseStorage.getInstance().getReference().child("Usuarios/"+fAuth.getCurrentUser().getUid() + "/profile.jpg");
    ...
    private void updateOnlyUserInfo()
    {
        ...
        userMap.put("fName",fullNameEditText.getText().toString());
        userMap.put("email",adressEditText.getText().toString());
        userMap.put("fTelefono",userPhoneEditText.getText().toString());
        ...
        /*
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        startActivity(new Intent(SettinsActivity.this,MenuActivity.class));

         */
        Toast.makeText(SettinsActivity.this, "Informacion de Perfil actualizada", Toast.LENGTH_SHORT).show();
        finish();
                        /*
                    }
    ...
    private void uploaadImage()
    {
        final ProgressDialog progressDialog = new ProgressDialog(this);
        progressDialog.setTitle("Actualizando perfil");
        progressDialog.setMessage("Espere porfavor, mientras actualizamos su cuenta");
        ...
        if(imageUri != null)
        {
            final StorageReference fileRef = storageProfilePrictureRef
                    .child("Usuarios/"+fAuth.getCurrentUser().getUid() + "/profile.jpg");
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot)
            {
                if(dataSnapshot.exists())
                {
                    if(dataSnapshot.child("image").exists())
                    {
                        ...
                        String phone = dataSnapshot.child("fTelefono").getValue().toString();
